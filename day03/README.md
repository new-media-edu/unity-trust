...
### 1. [Bringing the Real World In: Importing Scans](scans.md)
...
### 3. [Basic Animation](animation.md)
Keyframing in the Animation window to make things move: a door swinging, a sculpture spinning, a platform rising. Works on cameras too, which is the simplest way to build a flythrough.

### 4. [Advanced Camera Movement](camera-movement.md)
**Optional.** Timeline and Cinemachine, for cutting between several fixed angles and letting Unity blend between them. More powerful than keyframing, and considerably more setup. Skip it if the Animation window already gives you the shot you want.
